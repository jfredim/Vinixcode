...
{	
	...
	if(empty($name)) {
		...
		//updating the table
		$result = mysqli_query($mysqli, "UPDATE tag SET name='$name' WHERE id=$id");
		
		//redirectig to the display page. In our case, it is view.php
		header("Location: view_tags.php");
	}
}
?>
        <?php
...
$result = mysqli_query($mysqli, "SELECT * FROM tag WHERE id=$id");
...
?>
            ...
            <div class="row parte-gestor-entradas">
                <div class="panel-body">
                    ...
                    <form name="form1" method="post" action="edit_tags.php">
